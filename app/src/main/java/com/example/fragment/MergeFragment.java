...
import com.example.st046_audioeditorandmusiceditor.databinding.FragmentMergeBinding;
...
public class MergeFragment extends Fragment {
    ...
    public ArrayList<AudioFile> getMp3CutterAudioFiles(Context context) {
        ...
        File mp3CutterDir = new File(context.getExternalFilesDir(null), "MergeAudio");
