...
public class Voichangercustom extends View {
    ...
    public Voichangercustom(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(event.getX() - thumbX) < thumbRadius) {
                    ...
                    if (listener != null) {
                        ...
                        int newMediaPlayerPosition = (int) (newPosition * exoPlayer.getDuration());
                        exoPlayer.seekTo(newMediaPlayerPosition); // Cập nhật vị trí phát nhạc
                    }
                }
                return true;
        }
