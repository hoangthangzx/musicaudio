...
import com.example.st046_audioeditorandmusiceditor.databinding.FragmentVolumeBinding;
...
public class VolumeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        } else {   binding.recy.setVisibility(View.VISIBLE);
    ...
    public ArrayList<AudioFile> getAudioFiles(Context context) {
        ...
        File audioDir = new File(context.getExternalFilesDir(null), "Volume");
