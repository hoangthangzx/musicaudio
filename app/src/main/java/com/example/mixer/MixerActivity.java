...
public class MixerActivity extends AppCompatActivity {
    ...
    private static final String TAG = "MixerActivity";
...
//            Log.e(TAG, "log1."+AudioUtils.getSelectedAudioFiles());
//        }
//
//        mixerAdapter = new MixerAdapter(AudioUtils.getSelectedAudioFiles(), this, audioFile -> {
//            currentAudioUri = audioFile.getUri();  // Ví dụ lấy uri
//
//             name = audioFile.getName();
//            dur = audioFile.getDuration();
//            size = audioFile.getSize();
//            date = audioFile.getDate();
//            if (currentAudioUri.isEmpty()){
...
//            Intent mp3cutter = new Intent(MixerActivity.this, SlectaudioActivity.class);
...
//            cleanupMediaPlayers();
//            Intent mp3cutter = new Intent(MixerActivity.this, Cutaudio2Activity.class);
//            mp3cutter.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//            mp3cutter.putExtra("key", "mixer");
//
//            mp3cutter.putExtra("outputAudioPath", currentAudioUri);
...
//                cleanupMediaPlayers();
//                AudioUtils.saveSelectedAudioFiles(audioFilesList);
//                Intent mixer = new Intent(MixerActivity.this, SelectActivity.class);
...
//        super.onPause();
//        if (mediaPlayer != null && mediaPlayer.isPlaying()) {
//            binding.music.setImageResource(R.drawable.mergepaush);
...
//            }
//            binding.music.setImageResource(R.drawable.mergeplay);
//            isPlaying = true;
//        } else {
//            // Pausing playback
//            for (MediaPlayer player : mediaPlayers) {
...
//        super.onBackPressed();
//        Intent mixer = new Intent(MixerActivity.this, HomeActivity.class);
//        mixer.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//        mixer.putExtra("key", "mixer");
//        startActivity(mixer);
//        cleanupMediaPlayers();
...
//
//
//    private void removeCurrentAudio() {
//        ArrayList<AudioFile> audioFilesList = AudioUtils.getSelectedAudioFiles();
//
//        // Check if currentAudioUri is not null
//        if (currentAudioUri != null && audioFilesList != null) {
//            // Find the audio file with the current URI and remove it
//            for (int i = 0; i < audioFilesList.size(); i++) {
//                AudioFile audioFile = audioFilesList.get(i);
//                if (audioFile.getUri().equals(currentAudioUri)) {
//                    // Remove the item from the list
//                    audioFilesList.remove(i);
//
//                    // Notify the adapter that the item has been removed
//                    mixerAdapter.notifyItemRemoved(i);
//                    Log.d(TAG, "Removed audio file with URI: " + currentAudioUri);
//                    break;
//                }
//            }
...
//            showToast("Đã xóa file âm thanh khỏi danh sách.");
//        } else {
//            Log.e(TAG, "Current audio URI is null or audioFilesList is empty.");
//        }
//    }
//
//    private void mixAudioFiles(String outputFileName) {
//        ArrayList<AudioFile> audioFilesList = getIntent().getParcelableArrayListExtra("audio_files_list");
...
//            cleanupMediaPlayers();
//            Intent mixer = new Intent(MixerActivity.this, Selectaudio2Activity.class);
//            mixer.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//            mixer.putExtra("key", "mixer");
//            startActivity(mixer);
//        });
...
//
//    @Override
//    public void onAudioClick(String audioFile) {
...
//
//    @Override
//    public void onAudioClick(AudioFile audioFile) {
//
//    }
//
//
