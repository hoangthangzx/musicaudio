...
public class interectAdapter extends RecyclerView.Adapter<interectAdapter.BottleViewHolder> {

    private final List<HomeItem> homeitem;
    private final interectAdapter.OnItemClickListener listener;
    private final Context context;
    private String selectedItemName;

    public interectAdapter(Context context, List<HomeItem> homeitem, interectAdapter.OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public interectAdapter.BottleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemhomeBinding binding = ItemhomeBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new interectAdapter.BottleViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull interectAdapter.BottleViewHolder holder, int position) {
        ...
        holder.binding.name.setText(item.getName());  // Set the item name for TextView
