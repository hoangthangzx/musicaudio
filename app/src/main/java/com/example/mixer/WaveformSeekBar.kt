...
import com.example.cutter.RangeChangeListener
import com.example.cutter.WaveformOptions
...
class WaveformSeekBar @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in start until (barsToDraw + start + 3)) {
            ...
            // Đổi màu cột thành Cyan nếu nó nằm trong khoảng thời gian bắt đầu và kết thúc
