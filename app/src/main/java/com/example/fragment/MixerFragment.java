...
import com.example.st046_audioeditorandmusiceditor.databinding.FragmentMixerBinding;
...
public class MixerFragment extends Fragment {
    ...
    public ArrayList<AudioFile> getMp3CutterAudioFiles(Context context) {
        ...
        File mp3CutterDir = new File(context.getExternalFilesDir(null), "MixedAudio");
